<template>
  <div class="flex space-x-3 flex-col md:flex-row overflow-hidden">
    <div
      class="h-48 w-full md:w-1/2 grid place-items-center border shrink-0 rounded-xl overflow-hidden"
    >
      <img
        :src="imagesUrl"
        alt="img"
      ...
      />
      <Icon name="i-heroicons-photo" class="h-16 w-16" v-else />
    </div>
    <div class="p-2 space-y-3">
      ...
      <div>
        ...
        >
          ...
          {{
            alreadyHaveImage ? $t("change_image_txt") : $t("upload_image_txt")
          }}
        </button>
      </div>
    </div>
